				...
				if(!empty($incompleta)){
					...
					if ($prepapre4) {
						$alertProceso = "<div class='alert bg-success text-center'>
											Variable Incompleta".$incompleta."Se actualizo correctamente la orden de compra <a href='workspace.php?funcion=exportacioneslogistica' class='text-decoration-none text-white'>¡Actualice la pagina!<br><i style='border: none; background-color: transparent;'class='fas fa-sync-alt fa-'></i></a>
										</div>";
					} else {
					...
					if ($prepapre4) {
						$alertProceso = "<div class='alert bg-success text-center'>
											Variable completa".$completa." actualizo correctamente la orden de compra <a href='workspace.php?funcion=exportacioneslogistica' class='text-decoration-none text-white'>¡Actualice la pagina!<br><i style='border: none; background-color: transparent;'class='fas fa-sync-alt fa-'></i></a>
										</div>";
					} else {
						$alertProceso = "<div class='alert bg-danger text-center'>
											No se pudo actualizar la orden de compra en la siguiente etapa!
