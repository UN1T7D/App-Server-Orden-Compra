<?php
	...
	if ($result>0) {
			...
			if ($f>0) {
				...
				$sql="INSERT INTO oc(oc,nit ,finicio, estado,idpais_etapa,visible)
				VALUES ('$oc','$nit','$finicio','$estatus','$idpais_etapa','$visible')";
	...
	if($resultado) {
		...
		<div class='alert bg-success text-white text-center'>
			Se ha ingresado correctamente su orden de compra. <a href='workspace.php?funcion=exportacionesexpo' class='text-decoration-none text-white'>¡Actualice la pagina!<br><i style='border: none; background-color: transparent;'class='fas fa-sync-alt fa-'></i></a>
		</div>";
		...
		echo "pais etapa : ".$idpais_etapa."</br>"; */
