		...
		try {
			...
			if($resultado) {
				...
				<div class='alert bg-success text-white text-center'>
					Se ha inicializado correctamente su orden de compra, verifique en el apartado del proceso. <a href='workspace.php?funcion=exportaciones' class='text-decoration-none text-white'>¡Actualice la pagina!<br><i style='border: none; background-color: transparent;'class='fas fa-sync-alt fa-'></i></a>
				</div>";
