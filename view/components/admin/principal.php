...
include_once("../../controller/procesos.php");

if (isset($_POST["ordenes_compra_crear"])) {

  require_once("../../controller/admin/agregarOC.php");

}elseif (isset($_POST["ordenes_compra_iniciar"])) {
  
  require_once("../../controller/admin/actinicioadmin.php");

}elseif (isset($_POST["ordenes_compra_cancelar"])) {
  
  require_once("../../controller/admin/cancelarOC.php");
  
}elseif (isset($_POST["ordenes_compra_siguiente"])) {
  
  require_once("../../controller/admin/finalizar.php");
...
if($_SESSION['vsTipo']==1 || $_SESSION['vsTipo']==4){
