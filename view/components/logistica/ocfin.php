...
if(isset($_POST["modificarexportacion"])) {

  require_once("../../controller/exportacion/modificarOC.php");

}elseif(isset($_POST["eliminarexportacion"])){

  require_once("../../controller/exportacion/eliminarCancelado.php");
                                ...
                                <form class="form-horizontal" method="POST"  autocomplete="off">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-4">
                                      ...
                                      <select class="browser-default custom-select" id="estado" name="estado" disabled>
                                    ...
                                    <div class="form-group col-md-4">
                                      ...
                                      <select class="browser-default custom-select" id="visible" name="visible" disabled>
                            ...
                            <div class="modal-body">
                              <form class="form-horizontal" method="POST" autocomplete="off">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <button type="submit" name="eliminarexportacion" class="btn btn-primary">Aceptar</button>
                                </div>
                              </form>
                            </div>
                          </div>
