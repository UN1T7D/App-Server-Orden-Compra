...
if (isset($_POST["ordenes_compra_crear"])) {

  require_once("../../controller/exportacion/agregarOC.php");

}elseif (isset($_POST["ordenes_compra_iniciar"])) {
  
  require_once("../../controller/exportacion/actinicioexpor.php");

}elseif (isset($_POST["ordenes_compra_cancelar"])) {
  
  require_once("../../controller/exportacion/cancelarOC.php");
  
}elseif (isset($_POST["ordenes_compra_siguiente"])) {
  
  require_once("../../controller/exportacion/finalizar.php");

}elseif(isset($_POST["desactivarOCExpo"])){

  require_once("../../controller/exportacion/ocultar.php");
                ...
                <form class="form-horizontal" method="POST" autocomplete="off">
                  ...
                  <div class="subir row">
                    ...
                    <div class="col-md-2 p-2">
                      <button type="submit" name="desactivarOCExpo" style="border: none; color: #FF000C; background-color: transparent;" title="Ocultar">
