...
if (isset($_POST['adminaggcliente'])) {
  require_once("../../controller/exportacion/insertarcliente.php");
}elseif (isset($_POST['admineditcliente'])) {
  require_once("../../controller/exportacion/modificarcliente.php");
}elseif (isset($_POST['admeliminarcliente'])) {
  require_once("../../controller/exportacion/eliminarcliente.php");
}
else {
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col-md-12 m-auto">
                                    ...
                                    <label for="" class="text-center display-6">Estas seguro de eliminar el registro</label><br>
                                  </div>
                                </div>
                ...
                <div class="modal-body">
                  <form class="form-horizontal" method="POST" autocomplete="off">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="pais">Pais</label>
                        <!-- <input list="bp" type="text"  id="pais" > -->
                        <select id="bp"name="pais"class="form-control">
                          <?php
